...
class WebDisplayWidget extends StatefulWidget {
  ...
  const WebDisplayWidget({super.key, required this.jsonData, this.onWebViewCreated});
      ...
      child: Container(
        ...
        child: InAppWebView(
          ...
          shouldOverrideUrlLoading: (controller, navigationAction) async {
            ...
            if (uri?.path.contains('product_display.html') == false) {
              setState(() {
                linkClicked = true;
              });
            }
          ...
          onLoadStop: (controller,uri) async {
            if (uri?.path.contains('product_display.html') == false) return;
